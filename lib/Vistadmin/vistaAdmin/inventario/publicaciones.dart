  ...
  Future<void> _uploadPublicationImages(String _userId) async {
    ...
    try {
      ...
      for (File imageFile in _selectedImages.take(4)) {
        ...
        String storagePath =
            'Administrador/$_userId/Publicaciones/${DateTime.now().millisecondsSinceEpoch}.webp';
      ...
      DocumentReference publicationRef = FirebaseFirestore.instance
      ...
      await publicationRef.set({
        ...
        'megusta': null,
        'Comentarios': null,
        'imageRatio': {'width': _aspectX, 'height': _aspectY},
      });
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: IconButton(
                ...
                onPressed: () async {
                  if (!_isLoading) {
                    final hayDescripcion = _descripcionController.text
                        .trim()
                        .isNotEmpty;
                    final hayImagenPrincipal = _mainImage != null;
                    final hayImagenesSeleccionadas = _selectedImages.isNotEmpty;
