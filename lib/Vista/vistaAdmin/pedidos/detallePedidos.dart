...
class _EmpresaPedidosScreenState extends State<EmpresaPedidosScreen> {
  ...
  Future<List<Map<String, dynamic>>> obtenerPedidosConCliente() async {
    ...
    try {
      // Obtenemos el documento específico usando compraId
      ...
      final clienteData = await obtenerCliente(data['usuarioId']);

      return [
        {'compra': data, 'cliente': clienteData, 'pedidoId': docSnapshot.id},
      ];
    } catch (e) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          pedidos.sort((a, b) {
            final dataA = a['compra'] as Map<String, dynamic>;
            final dataB = b['compra'] as Map<String, dynamic>;
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final data = pedido['compra'] as Map<String, dynamic>;
              final cliente = pedido['cliente'] as Map<String, dynamic>?;
              final productos = List<Map<String, dynamic>>.from(
                data['productos'] ?? [],
              );
              final estadoActual = (data['estado'] ?? 'Sin estado').toString();
              final fecha = (data['fecha'] as Timestamp?)?.toDate();
              final pedidoId = pedido['pedidoId'] as String;
                                ...
                                children: [
                                  ...
                                  if ((categoria == 'Ropa' ||
                                    ...
                                    SingleChildScrollView(
                                      ...
                                      child: Row(
                                        children: producto['tallas'].entries
                                            .map<Widget>((e) {
                                              return Container(
