          ...
          children: [
            ...
            pw.Table(
              ...
              children: [
                ...
                _buildRow(
                  'Descuentos',
                  'S/ ${descuentosTotales.toStringAsFixed(2)}',
                ),
                _buildRow(
                  'Impuestos',
                  'S/ ${impuestosTotales.toStringAsFixed(2)}',
                ),
                _buildRow(
                  'Subtotal promedio',
  ...
  static Future<File> generarBoletaCompra({
    ...
    final productosConImagen = await Future.wait(
      productos.map((producto) async {
        ...
        return {...producto, 'imagen': imageProvider};
      }),
    );
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    pw.Row(
                      ...
                      children: [
                        pw.Text('Descuento:'),
                        pw.Text('S/. ${_formatearMoneda(data['descuento'])}'),
                      ],
                    ),
                    pw.SizedBox(height: 10),
                    pw.Row(
                      ...
                      children: [
                        ...
                        pw.Text('S/. ${_formatearMoneda(data['impuesto'])}'),
                      ],
                    ),
                    pw.SizedBox(height: 10),
                    pw.Divider(),
