...
class FirestoreService {
  ...
  static Future<List<DocumentSnapshot>> fetchProductosVinos() async {
    try {
      Query productosQuery = FirebaseFirestore.instance.collection(
  ...
  static Future<List<Map<String, dynamic>>> fetchPublicacionesConEmpresa({
    ...
    try {
      ...
      final List<Future<Map<String, dynamic>>> futures = subset.map((
        pubDoc,
      ) async {
        ...
        final comentariosFuture = pubDoc.reference
            .collection('comentarios')
            .get();
        final dioLikeFuture = pubDoc.reference
            .collection('meGustas')
            .doc(userId)
            .get();
