...
class BuscarPageVinosC extends StatefulWidget {
  const BuscarPageVinosC({super.key});

  @override
  _BuscarPageState createState() => _BuscarPageState();
}

class _BuscarPageState extends State<BuscarPageVinosC> {
  ...
  void _fetchAndRedactEmpresas() async {
    ...
    setState(() {
      ...
      _empresas = List.generate(
        0,
        (index) => {'userid': '', 'nombre': '', 'perfilEmpresa': ''},
      );
    });
                                ...
                                : TextButton.icon(
                                    ...
                                    onPressed: () {
                                      final currentUserId = FirebaseAuth
                                          ...
                                          .currentUser
                                          ?.uid;
                                      if (empresa['userid'] == currentUserId) {
                                        ...
                                        navegarConSlideDerecha(
                                          context,
                                          VisitaperfilScreem(empresa: empresa),
                                        );
                                      }
                                    },
