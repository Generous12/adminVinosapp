        ...
        onPressed: () async {
          if (_user == null) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text('Por favor, inicie sesión primero.')),
            );
            return;
          }
  ...
  Future<void> _deleteUserAccount() async {
    try {
      if (_user != null) {
        ...
        final userStorageRef = FirebaseStorage.instance.ref().child(
          'images/$userId',
        );
        ...
        for (var empresaDoc in empresaSnapshot.docs) {
          ...
          for (var productoDoc in productosSnapshot.docs) {
            ...
            final productoStorageRef = FirebaseStorage.instance.ref().child(
              'productos/$empresaId/${productoDoc.id}',
            );
          ...
          for (var pubDoc in publicacionesSnapshot.docs) {
            final publicacionStorageRef = FirebaseStorage.instance.ref().child(
              'publicaciones/$empresaId/${pubDoc.id}',
            );
