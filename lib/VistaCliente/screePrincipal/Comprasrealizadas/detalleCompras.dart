import 'package:app_bootsup/Modulo/boletaConEstadistica.dart';
import 'package:app_bootsup/VistaCliente/screePrincipal/Comprasrealizadas/verBolet.dart';
          ...
          Scaffold(
            ...
            body: FutureBuilder<Map<String, dynamic>>(
              ...
              builder: (context, snapshot) {
                ...
                final compraData =
                    snapshot.data!['compra'] as Map<String, dynamic>;

                final productos = List<Map<String, dynamic>>.from(
                  compraData['productos'] ?? [],
                );
                final estado = (compraData['estado'] ?? 'Sin estado')
                    .toString();
