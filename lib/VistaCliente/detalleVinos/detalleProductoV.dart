                                    ...
                                    child: ElevatedButton(
                                      onPressed: () {
                                        ...
                                        productoParaCarrito = {
                                          ...
                                          'precio': precioFinal,
                                          'imagenes':
                                              widget.producto['imagenes'],
                                          'imagenPrincipal': widget
                                          ...
                                          if (widget.producto.containsKey(
                                            'usuarioqueRegistro',
                                          ))
                                            'usuarioqueRegistro': widget
                                                .producto['usuarioqueRegistro'],
                                        };

                                        final carrito =
                                            Provider.of<CarritoServiceVinos>(
                                              context,
                                              listen: false,
                                            );
                                        ...
                                        SnackBarUtil.mostrarSnackBarPersonalizado(
                                          ...
                                          colorFondo: const Color.fromARGB(
                                            255,
                                            0,
                                            0,
                                            0,
